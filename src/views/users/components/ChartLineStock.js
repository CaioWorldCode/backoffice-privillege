...
const ChartLargeLineStock = () => {
    ...
    const data = React.useMemo(() => {
        return {
            labels: ['Quinta', 'Sexta', 'Sabádo', 'Domingo', 'Hoje'],
            datasets: [
                {
                    label: 'Stock',
                    data: [5, 4, 9, 11, 13],
    ...
    return (
        <>
            <Col xs="12" sm="auto" className="d-flex flex-column justify-content-between custom-tooltip pe-0 pe-sm-4">
                <p className="heading title mb-1">Solicitações</p>
                <div ref={tooltipRef} />
                <Row>
                    <Col xs="auto">
                        <div className="cta-3 text-alternate">12</div>
                        <div className="text-small text-muted mb-1">Esta semana</div>
                    </Col>
                    <Col>
                        <div className="cta-3 text-alternate">54</div>
                        <div className="text-small text-muted mb-1">Este mês</div>
                    </Col>
                </Row>
            </Col>
